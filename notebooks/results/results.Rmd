...
prices = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya-edited/Results/MCAPrices.csv")
prices
```
...
capacity = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya-edited/Results/MCACapacity.csv")
head(capacity)
```
...
```{r}
supply <-
    list.files(path = "/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya-edited/Results/Power/Supply/", pattern = "*.csv", full.names = T) %>% 
    map_df(~read_csv(.))
...
```{r}
metric_supply = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya-edited/Results/MCAMetric_Supply.csv")
...
```{r}
lcoe = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya-edited/Results/MCAMetric_Lcoe.csv")
