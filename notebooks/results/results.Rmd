...
ggplot(data=filter(lcoe_summed, sector=="power", year==2050), aes(x=technology, y=lcoe, fill=technology)) + geom_col() + theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
```