...
prices = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya/net-zero/Results/MCAPrices.csv")
prices
```
...
capacity = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya/net-zero/Results/MCACapacity.csv")
head(capacity)
```
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/net_zero-capacity_line_graph.pdf")
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/net_zero-capacity.pdf")
```
...
```{r}
metric_supply = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya/net-zero/Results/MCAMetric_Supply.csv")
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/net_zero-supply.pdf")
```
```{r}
filter(metric_supply_summed, year<=2050) %>% ggplot(aes(x=year, y=supply, fill=technology)) + geom_area(colour="black") + theme_classic()

ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/net_zero-geom_area-supply.pdf")
```

```{r}
lcoe = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/starter-kits/Kenya/net-zero/Results/MCAMetric_Lcoe.csv")
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/net_zero-lcoe_line_graph.pdf")
```
