...
prices = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/scenarios/Kenya/fossil_fuel/Results/MCAPrices.csv")
prices
```
...
capacity = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/scenarios/Kenya/fossil_fuel/Results/MCACapacity.csv")
head(capacity)
```
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/fossil-fuelcapacity_line_graph.pdf")
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/fossil-fuelcapacity.pdf")
```
...
```{r}
metric_supply = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/scenarios/Kenya/fossil_fuel/Results/MCAMetric_Supply.csv")
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/fossil-fuelsupply.pdf")
```


```{r}
lcoe = read_csv("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/data/processed/scenarios/Kenya/fossil_fuel/Results/MCAMetric_Lcoe.csv")
...
ggsave("/Users/alexanderkell/Documents/SGI/Projects/11-starter-kits/reports/figures/fossil-fuellcoe_line_graph.pdf")
```
